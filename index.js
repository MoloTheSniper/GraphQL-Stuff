...
const typeDefs = gql`
    type Query {
        hello: [String]
        Malana: Int
        products: [Product!]! #scalar type of Products below
    ...
    Query: 
      {
          ...
          product: (parent, args, context) => //args = id
          {
              const { id } = args.id; //object destructurizing
          ...
          {
            const { id } = args; //object destructurizing
